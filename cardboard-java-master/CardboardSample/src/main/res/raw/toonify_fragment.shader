...
float HueLevels[] = float[HueLevCount] (0.0,140.0,160.0,240.0,240.0,360.0);
float SatLevels[] = float[SatLevCount] (0.0,0.15,0.3,0.45,0.6,0.8,1.0);
float ValLevels[] = float[ValLevCount] (0.0,0.3,0.6,1.0);
